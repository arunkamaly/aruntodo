...
class AccountsTests(TestCase):
    ...
    def test_get_register(self):
        response = self.client.get(reverse('userauth:register'))
        self.assertTemplateUsed(response, 'userauth/register.html')
        self.assertIsInstance(response.context['form'], RegistrationForm)

    def test_get_login(self):
        response = self.client.get(reverse('userauth:login'))
        self.assertTemplateUsed(response, 'userauth/login.html')
        self.assertIsInstance(response.context['form'], LoginForm)

    def test_register(self):
        response = self.client.post(
            reverse('userauth:register'), data=self.register_data
        )
    ...
    def test_login(self):
        ...
        response = self.client.post(reverse('userauth:login'), data=login_data)
